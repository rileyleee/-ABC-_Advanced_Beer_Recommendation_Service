"""
Django settings for beer_recommend_prj project.
...
SECRET_KEY = "django-insecure-g&g3wbp=_!f@w19d*#5&)0t80el8yh&=yy#t8s6s$k^(983+*n"
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            BASE_DIR / "beer_recommend_prj" / "templates",
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "beer_recommend_prj.wsgi.application"
